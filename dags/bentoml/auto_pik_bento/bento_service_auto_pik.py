...
df = pd.read_csv("/opt/airflow/dags/data/link_cat_pik_quicklinkbox.csv")
...
with open('/opt/airflow/dags/data/count_vectorizer', 'rb') as f:
    count_vectorizer = pickle.load(f)

with open('/opt/airflow/dags/data/tfidf_transformer', 'rb') as f:
    tfidf_transformer = pickle.load(f)

with open('/opt/airflow/dags/data/feature_names', 'rb') as f:
    feature_names = pickle.load(f)


model = BERTopic.load("/opt/airflow/dags/data/paraphrase-multilingual-MiniLM-L12-v2_40_20")
...
model_file = "/opt/airflow/dags/data/paraphrase-multilingual-MiniLM-L12-v2_40_20"
...
svc = bentoml.Service("bertopic_autopik_bento", runners=[bertopik_runner])
...
# input_spec = Multipart(user_id=Text(), user_data=PandasDataFrame())
